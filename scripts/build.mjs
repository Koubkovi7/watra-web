...
await writeFile(path.join(output,'index.html'),'<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>WATRA — Choose your language</title><link rel="stylesheet" href="/style.css"><main class="wrap section"><a class="brand" href="/cs/">WATRA</a><h1>Vítejte.<br><em>Welcome.</em></h1><div class="actions"><a class="button" href="/cs/" data-language="cs">Česky →</a><a class="button outline" href="/en/" data-language="en">English →</a></div></main></html>');
